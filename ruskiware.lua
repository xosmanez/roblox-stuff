...
local shoot = Instance.new("TextLabel")
...
tab.BorderColor3 = Color3.fromRGB(255, 170, 255)
tab.Position = UDim2.new(0.875, 0, -0.00112564862, 0)
tab.Size = UDim2.new(0, 222, 0, 15)
tab.Active = true
tab.Draggable = true
...
shoot.BackgroundTransparency = 1.000
shoot.Position = UDim2.new(-0.0272003729, 0, -0.0524512455, 0)
shoot.Size = UDim2.new(0, 54, 0, 16)
...
ware.Position = UDim2.new(0.115616143, 0, -0.0524512529, 0)
ware.Size = UDim2.new(0, 54, 0, 16)
ware.Font = Enum.Font.SourceSans
ware.Text = "Ware"
ware.TextColor3 = Color3.fromRGB(255, 170, 255)
ware.TextScaled = true
ware.TextSize = 14.000
ware.TextWrapped = true

TextLabel.Name = "|"
TextLabel.Parent = tab
TextLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.BackgroundTransparency = 1.000
TextLabel.Position = UDim2.new(0.26806739, 0, -0.0832204968, 0)
TextLabel.Size = UDim2.new(0, 21, 0, 16)
...
cb.Position = UDim2.new(0.340177536, 0, -0.0832204148, 0)
cb.Size = UDim2.new(0, 69, 0, 17)
...
TextLabel_2.Position = UDim2.new(0.617380202, 0, -0.0832204893, 0)
TextLabel_2.Size = UDim2.new(0, 21, 0, 16)
...
time.Position = UDim2.new(0.714694917, 0, 0, 0)
time.Size = UDim2.new(0, 44, 0, 15)
...
local function WZXEE_fake_script() -- time.LocalScript 
...
coroutine.wrap(WZXEE_fake_script)()
...
local cfglocation = "shootware.cfg/" 
makefolder("shootware.cfg") 
...
function library:New(name) 
	...
	cursor.ZIndex = 1000 
	cursor.ImageColor3 = Color3.fromRGB(255, 170, 255) 
	...
	Menu.Name = "Menu" 
	Menu.Parent = Npt 
	Menu.BackgroundColor3 = COL3RGB(12, 12, 12)
        Menu.BorderColor3 = Color3.fromRGB(255, 170, 255) 
	Menu.Position = UDIM2(0.5, -300, 0.5, -300) 
	Menu.Size = UDIM2(0, 740, 0, 570)
	...
	do
		...
		TextLabel.BorderColor3 = Color3.fromRGB(255, 255, 127)
		TextLabel.Position = UDim2.new(0, 0, 0.804173291, 0)
	...
	TextLabel.BackgroundTransparency = 1 
	TextLabel.Position = UDIM2(0, 13, 0, 43) 
	TextLabel.Size = UDIM2(0, 0, 0, 29) 
	TextLabel.Size = UDIM2(0, txt:GetTextSize(name, 15, Enum.Font.GothamSemibold, Vec2(590, TextLabel.AbsoluteSize.Y)).X, 0, 29) 
	TextLabel.Font = Enum.Font.GothamSemibold 
	TextLabel.Text = name 
	TextLabel.TextColor3 = COL3RGB(255, 255, 255)
	TextLabel.TextStrokeColor3 = COL3RGB(255, 255, 255)
	...
	TabButtons.Position = UDIM2(0, 60, 0, 10)
	TabButtons.Size = UDIM2(0, 0, 0, 15) 
	...
	function menu:Tab(text) 
		...
		TextButton.BackgroundColor3 = COL3RGB(10, 11, 13) 
		TextButton.BackgroundTransparency = 1
		TextButton.Size = UDIM2(1, 20, 0, 20)
		...
		TabGui.Name = "TabGui" 
		TabGui.Parent = Tabs 
		TabGui.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
		...
		Left.Name = "Left" 
		Left.Parent = TabGui 
		Left.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
		Left.BackgroundTransparency = 1.000 
		Left.Position = UDIM2(0, 159, 0, 11) 
		...
		Right.Name = "Right" 
		Right.Parent = TabGui 
		Right.BackgroundColor3 = Color3.fromRGB(255, 170, 255)
		Right.BackgroundTransparency = 1.000 
		Right.Position = UDIM2(0, 445, 0, 11) 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			Section.BackgroundColor3 = COL3RGB(10, 11, 13) 
			Section.BorderColor3 = COL3RGB(53, 53, 53) 
			Section.BorderSizePixel = 0 
			Section.Size = UDIM2(1, 0, 0, 33) 

			SectionText.Name = "SectionText" 
			SectionText.Parent = Section 
			SectionText.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
			...
			SectionText.TextColor3 = Color3.fromRGB(255, 170, 255)
			SectionText.TextSize = 14.000 
			SectionText.TextXAlignment = Enum.TextXAlignment.Left 

			Inner.Name = "Inner" 
			Inner.Parent = Section 
			Inner.BackgroundColor3 = COL3RGB(10, 11, 13) 
			Inner.BorderColor3 = COL3RGB(53, 53, 53) 
			...
			sectiontabs.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
			...
			function MSector:Tab(text) 
				...
				tab1.Name = text 
				tab1.Parent = Inner 
				tab1.BackgroundColor3 = COL3RGB(10, 11, 13) 
				tab1.BorderColor3 = COL3RGB(53, 53, 53) 
				...
				TextButton.BackgroundColor3 = Color3.fromRGB(255, 170, 255)
				TextButton.BackgroundTransparency = 1.000 
				TextButton.Size = UDIM2(0, txt:GetTextSize(text, 14, Enum.Font.GothamSemibold, Vec2(700,700)).X + 2, 1, 0) 
				TextButton.Font = Enum.Font.GothamSemibold 
				TextButton.Text = text 
				TextButton.TextColor3 = COL3RGB(200, 200, 200) 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Dropdown.BackgroundColor3 = COL3RGB(200, 0, 0) 
						...
						Button.BackgroundColor3 = COL3RGB(10, 11, 13) 
						Button.BorderColor3 = COL3RGB(53, 53, 53) 
						Button.Position = UDIM2(0, 30, 0, 16) 
						Button.Size = UDIM2(0, 175, 0, 17) 
						Button.AutoButtonColor = false 
						Button.Font = Enum.Font.Gotham 
						Button.Text = "" 
						Button.TextColor3 = COL3RGB(10, 11, 13) 
						Button.TextSize = 13.000 

						TextLabel.Parent = Button 
						TextLabel.BackgroundColor3 = Color3.fromRGB(255, 170, 255)
						TextLabel.BackgroundTransparency = 1.000 
						TextLabel.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Drop.Parent = Button 
						Drop.Active = true 
						Drop.BackgroundColor3 = COL3RGB(10, 11, 13) 
						Drop.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = Color3.fromRGB(255, 170, 255) 
						...
						for i,v in ipairs(data.options) do 
							do 
								...
								TextLabel.Parent = Button 
								TextLabel.BackgroundColor3 = COL3RGB(10, 11, 13) 
								TextLabel.BackgroundTransparency = 1.000 
								TextLabel.BorderColor3 = COL3RGB(53, 53, 53) 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = Color3.fromRGB(255, 170, 255)
									else 
						...
						ImageLabel.BackgroundColor3 = Color3.fromRGB(255, 170, 255)
						...
						TextLabel_3.BackgroundColor3 = COL3RGB(200, 0, 0) 
					...
					elseif type == "ToggleKeybind" then 
						...
						Toggle.Name = "Toggle" 
						Toggle.Parent = tab1 
						Toggle.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						Toggle.BackgroundTransparency = 1.000 
						Toggle.Size = UDIM2(1, 0, 0, 15) 

						Button.Name = "Button" 
						Button.Parent = Toggle 
						Button.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(12, 12, 12) 
						Color.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(255, 170, 255)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(12, 12, 12)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(200, 200, 200)}) 
							end 
							values[tabname][sectorname][tabtext][text] = Element.value 
							callback(Element.value) 
						...
						do 
							...
							Keybind.BackgroundColor3 = COL3RGB(53, 53, 53) 
							Keybind.BorderColor3 = COL3RGB(53, 53, 53) 
							Keybind.Position = UDIM2(0, 270, 0.5, -6) 
							Keybind.Text = "..." 
							Keybind.Size = UDIM2(0, 43, 0, 12) 
							Keybind.Size = UDIM2(0,txt:GetTextSize("...", 14, Enum.Font.GothamSemibold, Vec2(700, 12)).X + 5,0, 12) 
							...
							Frame.BackgroundColor3 = COL3RGB(10, 11, 13) 
							Frame.BorderColor3 = COL3RGB(53, 53, 53) 
							...
							Hold.Name = "Hold" 
							Hold.Parent = Frame 
							Hold.BackgroundColor3 = COL3RGB(10, 11, 13) 
							Hold.BackgroundTransparency = 1.000 
							Hold.BorderColor3 = COL3RGB(53, 53, 53) 
							...
							Toggle.Name = "Toggle" 
							Toggle.Parent = Frame 
							Toggle.BackgroundColor3 = COL3RGB(10, 11, 13) 
							Toggle.BackgroundTransparency = 1.000 
							Toggle.BorderColor3 = COL3RGB(53, 53, 53) 
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.TextColor3 = Color3.fromRGB(255, 170, 255) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
							...
							Keybind.MouseButton1Down:Connect(function() 
								if not binding then 
									...
									binding = true 
									Keybind.Text = "..." 
									Keybind.Size = UDIM2(0,txt:GetTextSize("...", 14, Enum.Font.GothamSemibold, Vec2(700, 12)).X + 4,0, 12) 
								end 
							end) 
							...
							game:GetService("UserInputService").InputBegan:Connect(function(input) 
								...
								if binding then 
									...
									Keybind.Size = UDIM2(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.GothamSemibold, Vec2(700, 12)).X + 5,0, 12) 
									...
									if input.KeyCode.Name == "Backspace" then 
										Keybind.Text = "..." 
										Keybind.Size = UDIM2(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.GothamSemibold, Vec2(700, 12)).X + 4,0, 12) 
					...
					elseif type == "ToggleColor" then 
						tabsize = tabsize + UDIM2(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or Color3.fromRGB(255, 170, 255)} 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(10, 11, 13) 
						Color.BorderColor3 = COL3RGB(53, 53, 53) 
						Color.Position = UDIM2(0, 15, 0.5, -5) 
						Color.Size = UDIM2(0, 8, 0, 8) 
						...
						ColorP.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Colorpick.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						ColorDrag.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Huepick.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Huedrag.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						Huedrag.BorderColor3 = COL3RGB(53, 53, 53) 
					...
					elseif type == "ToggleTrans" then 
						tabsize = tabsize + UDIM2(0,0,0,16) 
						Element.value = {Toggle = data.default and data.default.Toggle or false, Color = data.default and data.default.Color or Color3.fromRGB(255, 170, 255), Transparency = data.default and data.default.Transparency or 0} 
						...
						local function update() 
							if Element.value.Toggle then 
								...
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(10, 11, 13)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(200, 200, 200)}) 
							end 
							values[tabname][sectorname][tabtext][text] = Element.value 
							callback(Element.value) 
						...
						Transpick.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						Transpick.BorderColor3 = COL3RGB(53, 53, 53) 
						...
						Transcolor.BackgroundColor3 = Color3.fromRGB(255, 170, 255)
						...
						Transdrag.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						Transdrag.BorderColor3 = COL3RGB(53, 53, 53) 
					...
					elseif type == "Dropdown" then 
						...
						Dropdown.Name = "Dropdown" 
						Dropdown.Parent = tab1 
						Dropdown.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						Dropdown.BackgroundTransparency = 1.000 
						Dropdown.Position = UDIM2(0, 0, 0.255102038, 0) 
						Dropdown.Size = UDIM2(1, 0, 0, 39) 
						...
						TextLabel_3.Parent = Dropdown 
						TextLabel_3.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						TextLabel_3.BackgroundTransparency = 1.000 
						TextLabel_3.Position = UDIM2(0, 32, 0, -1) 
						TextLabel_3.Size = UDIM2(0.111913361, 208, 0.382215232, 0) 
						TextLabel_3.Font = Enum.Font.GothamSemibold 
					...
					elseif type == "Slider" then 
						...
						Slider.Name = "Slider" 
						Slider.Parent = tab1 
						Slider.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
						...
						Button.BackgroundColor3 = COL3RGB(53, 53, 53) 
						Button.BorderColor3 = COL3RGB(10, 11, 13) 
						Button.Position = UDIM2(0, 30, 0, 15) 
						Button.Size = UDIM2(0, 175, 0, 5) 
						Button.AutoButtonColor = false 
						Button.Font = Enum.Font.Gotham 
						Button.Text = "" 
						Button.TextColor3 = COL3RGB(12, 12, 12) 
						Button.TextSize = 13.000 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 170, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 170, 255))} 
						UIGradient.Rotation = 90 
						UIGradient.Parent = Frame 

						Value.Name = "Value" 
						Value.Parent = Slider 
						Value.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
					...
					elseif type == "Button" then 
						...
						Button_2.BackgroundColor3 = COL3RGB(10, 11, 13) 
						Button_2.BorderColor3 = COL3RGB(53, 53, 53) 
						Button_2.Position = UDIM2(0, 30, 0.5, -9) 
						Button_2.Size = UDIM2(0, 175, 0, 18) 
						Button_2.AutoButtonColor = false 
						Button_2.Font = Enum.Font.Gotham 
						Button_2.Text = "" 
						Button_2.TextColor3 = COL3RGB(12, 12, 12) 
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Scroll.BackgroundColor3 = Color3.fromRGB(255, 170, 255)      
							...
							Frame.ScrollBarImageColor3 = Color3.fromRGB(255, 170, 255)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = Color3.fromRGB(255, 170, 255)      
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 170, 255)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
				elseif type == "Jumbobox" then      
					...
					Dropdown.Name = "Dropdown"      
					Dropdown.Parent = Inner      
					Dropdown.BackgroundColor3 = COL3RGB(10, 11, 13)      
					Dropdown.BackgroundTransparency = 1.000      
					Dropdown.Position = UDIM2(0, 0, 0.255102038, 0)      
					Dropdown.Size = UDIM2(1, 0, 0, 39)      
				...
				elseif type == "ToggleKeybind" then      
					...
					do      
						...
						Keybind.Name = "Keybind"      
						Keybind.Parent = Button      
						Keybind.BackgroundColor3 = COL3RGB(10, 11, 13)      
						Keybind.BorderColor3 = COL3RGB(53, 53, 53)      
						Keybind.Position = UDIM2(0, 270, 0.5, -6)      
						Keybind.Text = "..."      
						Keybind.Size = UDIM2(0, 43, 0, 12)      
				...
				elseif type == "ToggleColor" then      
					...
					Frame.Parent = ColorP      
					Frame.BackgroundColor3 = COL3RGB(10, 11, 13)      
					Frame.BorderColor3 = COL3RGB(10, 11, 13)      
					Frame.Position = UDIM2(-0.666666687, -170, 1.375, 0)      
					Frame.Size = UDIM2(0, 200, 0, 170)      
					Frame.Visible = false      
					Frame.ZIndex = 3      
				...
				elseif type == "TextBox" then 
					...
					Box.Name = "Box" 
					Box.Parent = Inner 
					Box.BackgroundColor3 = Color3.fromRGB(255, 170, 255) 
					Box.BackgroundTransparency = 1.000 
					Box.Position = UDIM2(0, 0, 0.542059898, 0) 
					Box.Size = UDIM2(1, 0, 0, 30) 

					TextBox.Parent = Box 
					TextBox.BackgroundColor3 = COL3RGB(10, 11, 13) 
					TextBox.BorderColor3 = COL3RGB(53, 53, 53) 
					...
					TextBox.TextColor3 = Color3.fromRGB(255, 170, 255)
					TextBox.TextSize = 13.000 

					values[tabname][sectorname][text] = Element.value 

					TextBox:GetPropertyChangedSignal("Text"):Connect(function() 
						if LEN(TextBox.Text) > 22 then 
							TextBox.Text = SUB(TextBox.Text, 1, 22) 
						end 
...
do 
	...
	Frame.BackgroundColor3 = COL3RGB(12, 12, 12) 
	Frame.BorderSizePixel = 0 
	Frame.Position = UDIM2(0, 0, 0.5, 0) 
	Frame.Size = UDIM2(1, 0, 0, 1) 

	Frame_2.Parent = ScreenGui 
	Frame_2.BackgroundColor3 = COL3RGB(12, 12, 12) 
...
local function ChangeCharacter(NewCharacter) 
	...
	if LocalPlayer.Character:FindFirstChildOfClass("Shirt") then 
		...
		if TBLFIND(values.visuals.world.removals.Jumbobox, "clothes") then 
...
local antiaim = gui:Tab("antiaim")
local visuals = gui:Tab("visuals") 
local players = gui:Tab("players")
local misc = gui:Tab("misc")
local config = gui:Tab("config")
local exploits = gui:Tab("exploits")
local skins = gui:Tab("skins")
local custommodels = gui:Tab("custommodels")
...
local main = legit:MSector("main", "Right") 
...
local settings = legit:Sector("settings", "Left") 
...
aimbot:Element("Toggle", "old position method")
if values.rage.ragebot["old position method"].Toggle then 
	args[1] = RageTarget 
	args[2] = RageTarget.OldPosition 
end  
aimbot:Element("Toggle", "resolve angles")
aimbot:Element("Toggle", "real position method [trash]")
aimbot:Element("Toggle", "force headshots")
aimbot:Element("Dropdown", "prediction", {options = {"off", "cframe", "old", "adaptive", "velocity"}})
aimbot:Element("Slider", "adaptive hitchance", {min = 1, max = 100, default = 0})
aimbot:Element("Toggle", "teammates")
aimbot:Element("Toggle", "auto baim")
aimbot:Element("Toggle", "knife aura")
aimbot:Element("Slider", "knife aura dist", {min = 1, max = 1000, default = 0})
...
local other = antiaim:Sector("other", "Right")
other:Element("Toggle", "remove head")
local Client = getsenv(game.Players.LocalPlayer.PlayerGui.Client)
fakeduckloop = false  
other:Element("Toggle", "fake duck",{},function(tbl)
...
other:Element("Toggle", "extend pitch")
other:Element("Toggle", "down anti-aim spectate")
other:Element("Toggle", "bloxsense anti-aim spectate")
other:Element("Toggle", "slidewalk")



local antiaim = antiaim:Sector("angles", "Left")
antiaim:Element("Toggle", "enabled")
antiaim:Element("Dropdown", "yaw type", {options = {"camera", "spin", "random"}})
antiaim:Element("Dropdown", "yaw base", {options = {"camera", "targets"}})
...
movement:Element("Slider", "speed", {min = 1, max = 260, default = 1}) 
movement:Element("Dropdown", "movetype", {options = {"defoult"}})
movement:Element("Dropdown", "speedtype", {options = {"gyro", "cframe"}})
...
local fakelag = exploits:Sector("fakelag", "Right")
fakelag:Element("ToggleKeybind", "newmethod", {}, function(tbl)
							if tbl.Toggle and tbl.Active then
								repeat
								LocalPlayer.Character.HumanoidRootPart.Anchored = true
								wait(values.exploits.fakelag['variance'].Slider)
								LocalPlayer.Character.HumanoidRootPart.Anchored = false
								wait(values.exploits.fakelag['variance'].Slider)
								LocalPlayer.Character.HumanoidRootPart.Anchored = true
								until										
...
fakelag:Element("ToggleKeybind", "oldmethod", {default = {Toggle = false}}, function(tbl) 
	if tbl.Toggle then 
	else 
...
fakelag:Element("Dropdown", "type", {options = {"new", "dynamic"}}) 
fakelag:Element("Slider", 'variance', {min = 1, max = 10, default = 2})     
...
coroutine.wrap(function()      
	while wait(1/16) do      
		LagTick = CLAMP(LagTick + 1, 0, values.exploits.fakelag.limit.Slider)      
		if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and values.exploits.fakelag.oldmethod.Toggle then    
			if LagTick == (values.exploits.fakelag.type.Dropdown == "new" and values.exploits.fakelag.limit.Slider or RANDOM(1, values.exploits.fakelag.limit.Slider)) then      
				game:GetService("NetworkClient"):SetOutgoingKBPSLimit(9e9)      
				FakelagFolder:ClearAllChildren()      
				LagTick = 0      
				if values.exploits.fakelag["visualize lag"].Toggle then      
					for _,hitbox in pairs(LocalPlayer.Character:GetChildren()) do      
						if hitbox:IsA("BasePart") and hitbox.Name ~= "HumanoidRootPart" then      
							...
							part.Color = values.exploits.fakelag["visualize lag"].Color      
				...
				if values.exploits.fakelag.oldmethod.Toggle then      
...
exploits:Element("ToggleKeybind", "dudos enimes")
exploits:Element("ToggleKeybind", "kill all")
exploits:Element("ToggleKeybind", "noclip",{},function(tbl)
	spawn(function()
		while values.exploits.exploits["noclip"].Toggle and values.exploits.exploits["noclip"].Active do
...
exploits:Element("Toggle", "infinite crouch")
exploits:Element("Toggle", "infinite cash", nil, function(tbl)
	if tbl.Toggle then
...
exploits:Element("ToggleKeybind","quck peek",{},function(tbl)
	spawn(function()
...
exploits:Element("Jumbobox", "shop", {options = {"inf time", "anywhere"}})
exploits:Element("Jumbobox", "damage bypass", {options = {"fire", "fall"}})
exploits:Element("Jumbobox", "gun modifiers", {options = {"recoil", "spread", "reload", "equip", "ammo", "automatic", "penetration", "firerate"}})

local players = players:Sector("players", "Left") 
players:Element("Toggle", "teammates") 
players:Element("ToggleColor", "box", {default = {Color = COL3RGB(255, 255, 255)}})
players:Element("ToggleTrans", "visible chams", {default = {Color = COL3RGB(255, 255, 255)}}, function(tbl)
	for _,Player in pairs(Players:GetPlayers()) do
		if Player.Character then
			for _2,Obj in pairs(Player.Character:GetDescendants()) do
				if Obj.Name == "VisibleCham" then
					if tbl.Toggle then
						if values.players.players.teammates.Toggle or Player.Team ~= LocalPlayer.Team then
							Obj.Visible = true
						else
							Obj.Visible = false
						end
...
players:Element("ToggleTrans", "wall chams", {default = {Color = COL3RGB(0, 0, 0)}}, function(tbl)
	for _,Player in pairs(Players:GetPlayers()) do
		if Player.Character then
			for _2,Obj in pairs(Player.Character:GetDescendants()) do
...
effects:Element("ToggleTrans", "glove chams", {default = {Color = COL3RGB(255, 255, 255)}}, function(val) 
...
effects:Element("Toggle", "sleeve chams", {default = {Color = COL3RGB(255, 255, 255)}}, function(val) 
	if RArm == nil or LArm == nil then return end 
	if val.Toggle then
		if RSleeve ~= nil then 
...
self:Element("Slider", "viewmodel x", {min = -20, max = 20}, function(val) 
	ViewmodelOffset = CF(values.visuals.self["viewmodel x"].Slider/7, values.visuals.self["viewmodel y"].Slider/7, values.visuals.self["viewmodel z"].Slider/7)
end) 
			...
			for _,part in pairs(LocalPlayer.Character:GetDescendants()) do 
				if part:IsA("Part") or part:IsA("MeshPart") then 
					if part.Transparency ~= 1 then 
						part.Transparency = LocalPlayer.Character:FindFirstChild("AIMING")  
					end 
				end 
				if part:IsA("Accessory") then 
					part.Handle.Transparency = LocalPlayer.Character:FindFirstChild("AIMING") 
				end 
			end 
		end 
	end)() 
...
world:Element("Toggle", "force crosshair")
world:Element("ToggleColor", "hitmarker", {default = {Color = COL3RGB(255, 255, 255)}})
world:Element("ToggleColor", "tint", {default = {Color = COL3RGB(255, 255, 255)}}, function(val) 
	if val.Toggle then 
...
world:Element("ToggleColor", "ambient", {default = {Color = COL3RGB(255,255,255)}}, function(val) 
	if val.Toggle then
...
world:Element("Jumbobox", "removeui", {options = {"all"}}, function(val) 
...
world:Element("Jumbobox", "removals", {options = {"scope", "flash", "smoke", "decals", "shadows", "clothes"}}, function(val) 
	local tbl = val.Jumbobox      
...
world:Element("Dropdown", "skybox", {options = {"none", "vivid sky", "blue nebula", "nebula", "dusty clouds", "purple sky", "clouds", "night", "minicraft", "rickroll", "Dababy", "MC"}}, function(tbl) 
...
world:Element("Dropdown", "hitsound", {options = {"none", "neverlose", "headshot", "skeet", "rust", "bag", "squash", "lessgo", "MCOOF", "baimware", "osu", "Tf2", "Slap", "1", "Minecraft", "jojo", "vibe", "supersmash", "epic", "retro", "quek"}}) 
...
local custom = custommodels:Sector("models", "Left")
...
custom:Element("Toggle", "Newan", nil, function(tbl)
	if tbl.Toggle then 
...
local configs = config:Sector("configs", "Left")
configs:Element("TextBox", "config", {placeholder = "config name"})
configs:Element("Button", "save", {}, function() if values.config.configs.config.Text ~= "" then library:SaveConfig(values.config.configs.config.Text) end end)
configs:Element("Button", "load", {}, function() if values.config.configs.config.Text ~= "" then ConfigLoad:Fire(values.config.configs.config.Text) end end)
configs:Element("Toggle", "watermark", {}, function(tbl)
	if tbl.Toggle then
		lol.Enabled = true
	else
		lol.Enabled = false
...
configs:Element("Toggle", "spectator lis", nil, function(tbl)
	...
	Spectators.BackgroundTransparency = 1
	...
	Text.Text = ""
	Text.TextColor3 = Color3.fromRGB(255, 37, 110)
	...
	Background.BackgroundColor3 = Color3.fromRGB(30, 30, 39)
	Background.BorderColor3 = Color3.fromRGB(30, 30, 39)
	...
	Color.BackgroundColor3 = Color3.fromRGB(255, 37, 110)
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "shootware" and "shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! shootware back ! " or "🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎🤟🏻😂😎 ", false, "Innocent", false, true)
			wait(values.misc.chat["speed"].Slider/1000)
		end
	end
end)
chat:Element("Dropdown", "type", {options = {"shootware", "emoji"}})
chat:Element("Slider", "speed", {min = 15, max = 300, default = 50}) 
...
local other = misc:Sector("other", "Right") 
other:Element("ToggleKeybind", "spam grenades") 
coroutine.wrap(function() 
	while true do 
		wait(0.5) 
		if values.misc.other["spam grenades"].Toggle and values.misc.other["spam grenades"].Active then 
			local oh1 = game:GetService("ReplicatedStorage").Weapons[values.misc.other.grenade.Dropdown].Model 
			local oh3 = 25 
			local oh4 = 35 
			local oh6 = "" 
			local oh7 = "" 
...
other:Element("Dropdown", "grenade", {options = {"Flashbang", "Smoke Grenade", "Molotov", "HE Grenade", "Decoy Grenade"}})
other:Element("Button","dudos hitbox",{},function()
...
other:Element("Button", "server crasher", {}, function()      
	while true do
		pcall(function()
			game:GetService("RunService").RenderStepped:Wait()
			for i = 1,100,1 do
...
other:Element("Toggle", "remove killers", {}, function(tbl) 
	if tbl.Toggle then 
...
other:Element("Toggle", "buy any grenade") 



local oldgrenadeallowed = Client.grenadeallowed 
Client.grenadeallowed = function(...) 
	if values.misc.other["buy any grenade"].Toggle then
		return true 
	end 
...
RunService.RenderStepped:Connect(function(step) 
	...
	RageTarget = nil 
	Spin = CLAMP(Spin + values.antiaim.angles["spin speed"].Slider, 0, 360) 
	...
	if PlayerIsAlive then 
		...
		if values.exploits.exploits["dudos enimes"].Toggle and values.exploits.exploits["dudos enimes"].Active then
			for count = 1, 77, 1 do 
		...
		if values.exploits.exploits["infinite crouch"].Toggle then 
			Client.crouchcooldown = -0 
		end 
		if TBLFIND(values.exploits.exploits["gun modifiers"].Jumbobox, "firerate") then 
			Client.DISABLED = false 
		end 
		if values.exploits.exploits["kill all"].Toggle and values.exploits.exploits["kill all"].Active and LocalPlayer.Character:FindFirstChild("UpperTorso") and LocalPlayer.Character:FindFirstChild("Gun") then
			for _,Player in pairs(Players:GetPlayers()) do
		...
		if workspace:FindFirstChild("Map") and Client.gun ~= "none" and Client.gun.Name ~= "C4" then      
			if values.rage.ragebot.enabled.Toggle then      
				local Origin = values.rage.ragebot.origin.Dropdown == "character" and LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(10, 20, 10) or CamCFrame.p
				...
				for _,Player in pairs(Players:GetPlayers()) do      
					...
					if Player.Character and Player.Character:FindFirstChild("Humanoid") and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and Player ~= LocalPlayer then
						if values.rage.ragebot["resolve angles"].Toggle then
					...
					if Player.Character and Player.Character:FindFirstChild("Humanoid") and not Client.DISABLED and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and not Player.Character:FindFirstChildOfClass("ForceField") and GetDeg(CamCFrame, Player.Character.Head.Position) <= Stats["max fov"].Slider and Player ~= LocalPlayer then 
						if Player.Team ~= LocalPlayer.Team or values.rage.ragebot.teammates.Toggle and Player:FindFirstChild("Status") and Player.Status.Team.Value ~= LocalPlayer.Status.Team.Value and Player.Status.Alive.Value then 
							if Client.gun:FindFirstChild("Melee") and values.rage.ragebot["knife aura"].Toggle then 
								...
								local Ray = RAY(Origin, (Player.Character.Head.Position - Origin).unit * 1000) 
								...
								for _,Hitbox in ipairs(Stats.hitboxes.Jumbobox) do 
									if Stats["prefer body"].Toggle then 
										if Hitbox == "head" and (not values.rage.ragebot["auto baim"].Toggle or Player.Character:FindFirstChild("FakeHead")) then 
										...
										elseif Hitbox == "pelvis" then 
											INSERT(Hitboxes, Player.Character.LowerTorso) 
										elseif not values.rage.ragebot["auto baim"].Toggle or Player.Character:FindFirstChild("FakeHead") then 
											INSERT(Hitboxes, Player.Character.Head) 
										end 
									end 
								end
										...
										if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 4 then 
											if #Hits == 0 then 
												...
												if Damage >= Stats["minimum damage"].Slider then 
													...
													Filter = true      
													if values.rage.ragebot["automatic fire"].Dropdown == "standard" then      
														Client.firebullet()      
														if values.exploits.exploits["triple tap"].Toggle and values.exploits.exploits["triple tap"].Active then
															Client.firebullet()
															Client.firebullet()
                                                                                                                        Client.firebullet()
														end
													elseif values.rage.ragebot["automatic fire"].Dropdown == "hitpart" then 
														Client.firebullet() 
														local Arguments = { 
															[1] = EndHit, 
															[2] = EndHit.Position, 
			...
			elseif values.legit.aimbot["aim assist"].Toggle and values.legit.aimbot["aim assist"].Active and not library.uiopen then 
				...
				Fov.Color = Color3.fromRGB(255, 170, 255)
		...
		if UserInputService:IsKeyDown("Space") and values.misc.movement["bunny hop"].Toggle then 
			local add = 0 
			if values.misc.movement.movetype.Dropdown == "defoult" or values.misc.movement.movetype.Dropdown == "directional 2" then
			...
			if add == 0 and values.misc.movement.movetype.Dropdown == "defoult" and not UserInputService:IsKeyDown("W") then 
				BodyVelocity:Destroy() 
			else 
				if values.misc.movement.speedtype.Dropdown == "cframe" then 
					BodyVelocity:Destroy()
		...
		if values.antiaim.angles.enabled.Toggle and not DisableAA then 
			local Angle = -ATAN2(CamLook.Z, CamLook.X) + RAD(-90) 
			if values.antiaim.angles["yaw type"].Dropdown == "spin" then 
				Angle = Angle + RAD(Spin) 
			end 
			if values.antiaim.angles["yaw type"].Dropdown == "random" then 
				Angle = Angle + RAD(RANDOM(0, 360)) 
			end 
			local Offset = RAD(-values.antiaim.angles["yaw offset"].Slider - (values.antiaim.angles.jitter.Toggle and Jitter and values.antiaim.angles["jitter offset"].Slider or 0)) 
			local CFramePos = CF(Root.Position) * CFAngles(0, Angle + Offset, 0) 
			if values.antiaim.angles["yaw base"].Dropdown == "targets" then 
				local part 
				local closest = 9999 
				for _,plr in pairs(Players:GetPlayers()) do 
			...
			if values.antiaim.angles["body roll"].Dropdown == "180" then 
				Root.CFrame = Root.CFrame * CFAngles(values.antiaim.angles["body roll"].Dropdown == "180" and RAD(180) or 0, 1, 0) 
				LocalPlayer.Character.Humanoid.HipHeight = 3
			end 


			local Pitch = values.antiaim.angles["pitch"].Dropdown == "none" and CamLook.Y or values.antiaim.angles["pitch"].Dropdown == "up" and 1 or values.antiaim.angles["pitch"].Dropdown == "down" and -1 or values.antiaim.angles["pitch"].Dropdown == "zero" and 0 or values.antiaim.angles["pitch"].Dropdown == "random" and math.random(-10, 10)/10 or 2.5
			if values.antiaim.other["extend pitch"].Toggle and (values.antiaim.angles["pitch"].Dropdown == "up" or values.antiaim.angles["pitch"].Dropdown == "down") then
				Pitch = (Pitch*2)/1.6
			end
		...
		if values.antiaim.other["remove head"].Toggle then 
		...
		if TBLFIND(values.exploits.exploits["gun modifiers"].Jumbobox, "recoil") then 
	...
	for _,Player in pairs(Players:GetPlayers()) do 
		...
		if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Team ~= "TTT" and (Player.Team ~= LocalPlayer.Team or values.players.players.teammates.Toggle) and Player.Character:FindFirstChild("Gun") and Player.Character:FindFirstChild("Humanoid") and Player ~= LocalPlayer then 
			...
			local Drawings, Text = TBLFIND(values.players.players.outlines.Jumbobox, "drawings") ~= nil, TBLFIND(values.players.players.outlines.Jumbobox, "text") ~= nil 

			tbl.Box.Color = values.players.players.box.Color 
			tbl.Box.Size = Vec2(Size * 1.5, Size * 1.9) 
			tbl.Box.Position = Vec2(Pos.X - Size*1.5 / 2, (Pos.Y - Size*1.6 / 2)) 

			if values.players.players.box.Toggle then 
			...
			if values.players.players.health.Toggle then 
				tbl.Health.Color = values.players.players["health"].Color  
			...
			if values.players.players.weapon.Toggle then 
				tbl.Weapon.Color = values.players.players.weapon.Color 
				...
				tbl.Weapon.Font = Drawing.Fonts[values.players.players.font.Dropdown] 
				tbl.Weapon.Outline = Text 
				tbl.Weapon.Size = values.players.players.size.Slider 
			...
			if values.players.players.name.Toggle then 
				tbl.Name.Color = values.players.players.name.Color 
				tbl.Name.Text = Player.Name 
				tbl.Name.Position = Vec2(tbl.Box.Size.X/2 + tbl.Box.Position.X,  tbl.Box.Position.Y - 16) 
				tbl.Name.Font = Drawing.Fonts[values.players.players.font.Dropdown] 
				tbl.Name.Outline = Text 
				tbl.Name.Size = values.players.players.size.Slider 
				tbl.Name.Visible = OnScreen 
			else 
				tbl.Name.Visible = false 
			end 
			local LastInfoPos = tbl.Box.Position.Y - 1 
			if TBLFIND(values.players.players.indicators.Jumbobox, "armor") and Player:FindFirstChild("Kevlar") then 
				...
				tbl.Armor.Font = Drawing.Fonts[values.players.players.font.Dropdown] 
				tbl.Armor.Outline = Text 
				tbl.Armor.Size = values.players.players.size.Slider 
				tbl.Armor.Visible = OnScreen 

				LastInfoPos = LastInfoPos + values.players.players.size.Slider 
			else 
...
mt.__namecall = function(self, ...) 
	...
	if method == "FireServer" then 
		if LEN(self.Name) == 38 then 
			return 
		elseif self.Name == "FallDamage" and table.find(values.exploits.exploits["damage bypass"].Jumbobox, "fall")   then
			return
		elseif self.Name == "BURNME" and table.find(values.exploits.exploits["damage bypass"].Jumbobox, "fire") then
			return
		...
		if self.Name == "ReplicateCamera" and values.antiaim.other["bloxsense anti-aim spectate"].Toggle then      
			local ReplicateCamera = game.ReplicatedStorage.Events.ReplicateCamera
			plr.CameraCF.Value = plr.Character.Head.CFrame
		end      
	...
	if method == "FindPartOnRayWithWhitelist" and not checkcaller() and Client.gun ~= "none" and Client.gun.Name ~= "C4" then 
		if #args[2] == 1 and args[2][1].Name == "SpawnPoints" then 
			...
			if TBLFIND(values.exploits.exploits.shop.Jumbobox, "anywhere") then 
	...
	if method == "FindPartOnRayWithIgnoreList" and args[2][1] == workspace.Debris then 
		if not checkcaller() or Filter then
			if table.find(values.exploits.exploits["gun modifiers"].Jumbobox, "penetration") then
				table.insert(args[2], workspace.Map)
			end 
			if TBLFIND(values.exploits.exploits["gun modifiers"].Jumbobox, "spread") then 
			...
			if values.legit.aimbot["silent aim"].Toggle and values.legit.aimbot["silent aim"].Active and Stats["silent aim"].Toggle then 
				...
				coroutine.wrap(function() 
					...
					local Hit = RANDOM(1, 360) <= Stats.hitchance.Slider 
			...
			if RageTarget ~= nil then 
				local Origin = values.rage.ragebot.origin.Dropdown == "character" and LocalPlayer.Character.LowerTorso.Position + Vec3(10, 10, 10) or Camera.CFrame.p 
				if values.rage.ragebot["real position method [trash]"].Toggle then 
					spawn(function() 
	...
	if method == "LoadAnimation" and self.Name == "Humanoid" then
		if values.antiaim.other["slidewalk"].Toggle then
	...
	if method == "FireServer" and self.Name == "Hit" then 
		...
		if values.rage.ragebot["prediction"].Dropdown ~= "off" and RageTarget ~= nil then
			coroutine.wrap(function()
				if Players:GetPlayerFromCharacter(args[1].Parent) or args[1] == RageTarget then
					if values.rage.ragebot["prediction"].Dropdown == "cframe" then
						...
						if Velocity.magnitude >= 9 then
							args[2] = args[2] + Direction * (Ping / (POW(Ping, 1.5)) * (Direction / (Direction / 2))) 
							args[4] = 0 
							args[12] = args[12] - 500
						end
					else
						...
						if values.rage.ragebot["prediction"].Dropdown == "adaptive" then
							local Velocity = (RageTarget.Parent.HumanoidRootPart.Position - RageTarget.Parent.HumanoidRootPart.OldPosition.Value)/LastStep
							local Direction = Vector3.new(Velocity.X/Velocity.magnitude, 0, Velocity.Z/Velocity.magnitude)
							if Velocity.magnitude >= 9 then
								args[2] = args[2] + Direction * (Ping / (POW(Ping, 1.5)) * (Direction / (Direction / 3.1))) 
								args[4] = 0 
								args[12] = args[12] - 500
							end
							if values.rage.ragebot["prediction"].Dropdown == "old" then
								local Velocity = (RageTarget.Parent.HumanoidRootPart.Position - RageTarget.Parent.HumanoidRootPart.OldPosition.Value)/LastStep
								local Direction = Vector3.new(Velocity.X/Velocity.magnitude, 0, Velocity.Z/Velocity.magnitude)
		...
		if values.visuals.world["bullet tracers"].Toggle then 
			coroutine.wrap(function() 
				...
				beam.Size = Vector3.new(0.03, 0.06, (bk.Character.Head.Position - args[2]).magnitude)
				beam.CFrame = CFrame.new(bk.Character.Head.Position, args[2]) * CFrame.new(0, 0, -beam.Size.Z / 2)
...
oldIndex = hookmetamethod(game,"__index",function(self, key)      
	...
	if key == "Value" then
		if self.Name == "Auto" and table.find(values.exploits.exploits["gun modifiers"].Jumbobox, "automatic") then
			return true
		elseif self.Name == "ReloadTime" and table.find(values.exploits.exploits["gun modifiers"].Jumbobox, "reload") then
			return 0.001
		elseif self.Name == "EquipTime" and table.find(values.exploits.exploits["gun modifiers"].Jumbobox, "equip") then
			return 0.001
		elseif self.Name == "BuyTime" and table.find(values.exploits.exploits.shop.Jumbobox, "inf time") then
			return 5
		end
	end
...
mt.__newindex = function(self, i, v) 
	...
	if self:IsA("Humanoid") and i == "CameraOffset" then
		if values.antiaim.angles.enabled.Toggle and values.antiaim.angles["body roll"].Dropdown == "180" and not DisableAA then 
			v = v + Vec3(0, -2.5, 0) 
		end 
	end 
...
Crosshair:GetPropertyChangedSignal("Visible"):Connect(function(current) 
	...
	if not values.visuals.world["force crosshair"].Toggle then return end 
...
LocalPlayer.Additionals.TotalDamage:GetPropertyChangedSignal("Value"):Connect(function(current) 
	...
	coroutine.wrap(function() 
		if values.visuals.world.hitmarker.Toggle then 
			...
			Line.To = Vec2(x + 8, y + 8) 
			Line.Color = values.visuals.world.hitmarker.Color 
			Line.Visible = true 

			Line2.From = Vec2(x + 4, y - 4) 
			Line2.To = Vec2(x + 8, y - 8) 
			Line2.Color = values.visuals.world.hitmarker.Color 
			Line2.Visible = true 

			Line3.From = Vec2(x - 4, y - 4) 
			Line3.To = Vec2(x - 8, y - 8) 
			Line3.Color = values.visuals.world.hitmarker.Color 
			Line3.Visible = true 

			Line4.From = Vec2(x - 4, y + 4) 
			Line4.To = Vec2(x - 8, y + 8) 
			Line4.Color = values.visuals.world.hitmarker.Color 
			Line4.Visible = true 
...
Camera.ChildAdded:Connect(function(obj) 
	if TBLFIND(values.exploits.exploits["gun modifiers"].Jumbobox, "ammo") then 
		Client.ammocount = 1231345678908765
		Client.ammocount2 = 1231345678908765
	end 
	RunService.RenderStepped:Wait() 
...
LocalPlayer.Cash:GetPropertyChangedSignal("Value"):Connect(function(cash) 
	if values.exploits.exploits["infinite cash"].Toggle and cash ~= 8000 then
		LocalPlayer.Cash.Value = 1234567890112
	end
end)
...
workspace.ChildAdded:Connect(function(obj) 
	if obj.Name == "Map" then 
		wait(5) 
		if values.misc.other["remove killers"].Toggle then 
			if workspace:FindFirstChild("Map") and workspace:FindFirstChild("Map"):FindFirstChild("Killers") then 
				local clone = workspace:FindFirstChild("Map"):FindFirstChild("Killers"):Clone() 
				clone.Name = "KillersClone" 
				clone.Parent = workspace:FindFirstChild("Map") 
...
LocalPlayer.CharacterAdded:Connect(function(char) 
	...
	LoadedAnim = LocalPlayer.Character.Humanoid
end)		
if LocalPlayer.Character ~= nil then 
	for i,v in pairs(LocalPlayer.Character:GetChildren()) do 
		if v:IsA("BasePart") and v.Transparency ~= 1 then 
...
Players.PlayerAdded:Connect(function(Player)
	Player:GetPropertyChangedSignal("Team"):Connect(function(new)
		...
		if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") then
			for _2,Obj in pairs(Player.Character:GetDescendants()) do
				if Obj.Name == "VisibleCham" then
					if values.players.players["visible chams"].Toggle then
						if values.players.players.teammates.Toggle or Player.Team ~= LocalPlayer.Team then
							Obj.Visible = true
						else
							Obj.Visible = false
					...
					Obj.Color3 = values.players.players["visible chams"].Color
				end
			end
		end
	end)
		...
		if Character ~= nil then
			...
			for _,obj in pairs(Character:GetChildren()) do
				if obj:IsA("BasePart") and Player ~= LocalPlayer and obj.Name ~= "HumanoidRootPart" and obj.Name ~= "Head" and obj.Name ~= "BackC4" and obj.Name ~= "HeadHB" then
					...
					VisibleCham.Size = obj.Size + Vector3.new(0.06,0.06,0.06)
					VisibleCham.AlwaysOnTop = false
					...
					VisibleCham.Color3 = values.players.players["visible chams"].Color
...
Players.PlayerAdded:Connect(function(Player)
	Player:GetPropertyChangedSignal("Team"):Connect(function(new)
		...
		if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") then
			for _2,Obj in pairs(Player.Character:GetDescendants()) do
				if Obj.Name == "WallCham" then
					if values.players.players["wall chams"].Toggle then
						if values.players.players.teammates.Toggle or Player.Team ~= LocalPlayer.Team then
							Obj.Visible = true
						else
							Obj.Visible = false
					...
					Obj.Color3 = values.players.players["wall chams"].Color
				end
			end
		end
	end)
		...
		if Character ~= nil then
			...
			for _,obj in pairs(Character:GetChildren()) do
				if obj:IsA("BasePart") and Player ~= LocalPlayer and obj.Name ~= "HumanoidRootPart" and obj.Name ~= "Head" and obj.Name ~= "BackC4" and obj.Name ~= "HeadHB" then
					...
					WallCham.ZIndex = 5
					WallCham.Size = obj.Size + Vector3.new(0.06,0.06,0.06)
					WallCham.AlwaysOnTop = true
					...
					WallCham.Color3 = values.players.players["wall chams"].Color
